matlabbatch{1}.spm.tools.beamforming.data.dir = {'D:\home\Data\4AshO\Phantom_Images'};
matlabbatch{1}.spm.tools.beamforming.data.D = {'D:\home\Data\4AshO\ROI_sim.mat'};
...
matlabbatch{3}.spm.tools.beamforming.features.plugin.cov.foi = [0 40];
matlabbatch{3}.spm.tools.beamforming.features.plugin.cov.taper = 'hanning';
matlabbatch{3}.spm.tools.beamforming.features.regularisation.mantrunc.pcadim = 100;
...
matlabbatch{5}.spm.tools.beamforming.output.plugin.image_dics.foi = [0 40];
